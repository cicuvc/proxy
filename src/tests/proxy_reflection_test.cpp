...
namespace proxy_reflection_tests_details {
    ...
    public:
        ...
        constexpr explicit TraitsReflector(std::in_place_type_t<T>)
            : is_default_constructible_(std::is_default_constructible_v<T>),
              ...
              is_nothrow_destructible_(std::is_nothrow_destructible_v<T>), is_trivial_(std::is_trivial_v<T>) {}
    ...
    struct TestRttiFacade
        : pro::facade_builder ::add_reflection<utils::RttiReflector>::add_direct_reflection<utils::RttiReflector>::build {};

    struct TestTraitsFacade : pro::facade_builder ::add_direct_reflection<TraitsReflector>::build {};
